...
public class InitBean {
	...
	public void init() {
		...
		try {
			...
			surgeryTreatment1.setId(providerService.addTreatment(surgeryTreatment1));
			...
			surgeryTreatment2.setId(providerService.addTreatment(surgeryTreatment2));
			...
			radiologyTreatment2.setId(providerService.addTreatment(radiologyTreatment2));
			...
			physiotherapyTreatment2.setId(providerService.addTreatment(physiotherapyTreatment2));
			...
			physiotherapyTreatment3.setId(providerService.addTreatment(physiotherapyTreatment3));
			...
			radiologyTreatment23.setId(providerService.addTreatment(radiologyTreatment23));
